                ...
                <div class="sidebar-scroll">
                    <nav>
                        <ul class="nav">
                            ...
                            <li><a href="deposit" class="  active"><i class="fa fa-credit-card"></i> <span>Deposit Money</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="panel-body">
                            <form action="deposit" cssClass="form-horizontal"
                                       method="post" modelAttribute="account">

                                <!-- need to associate this data with customer id -->
                                <div class="form-group"  style="margin: 20px">
                                    <label for="accountID" class="col-md-3 control-label">Account ID</label>
                                    <div class="col-md-9" style="margin: 20px">
                                        <label name="accountID" Class="form-control" id="accountID" />
                                    </div>
                                </div>
                                <div class="form-group"  style="margin: 20px">
                                    <label for="fullName" class="col-md-3 control-label">Customer Name</label>
                                    <div class="col-md-9" style="margin: 20px">
                                        <label name="customerName" Class="form-control" id="accountID" />${customerName}
                                    </div>
                                </div>
                                <div class="form-group" style="margin: 20px">
                                    <label for="money" class="col-md-3 control-label">Input Amount of money To Deposit</label>
                                    <div class="col-md-9" style="margin: 20px">
                                        <label name="money" Class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        <button cssClass="btn btn-primary">Deposit Money</button>
                                        </div>
                                    </div>
                            </form>
                        </div>
